...
scene_dir = "../scenes/slabs/"
scene_filename = "slabs_reproduce.xml"
gt_filename = "refs/slabs.exr"
timeout_list = [15, 30]
spp = 999999
...
common_imgproc.draw(test_id, timeout_list, output_name_list, gt_filename, vmax=1e9)